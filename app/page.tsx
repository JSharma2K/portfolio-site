...
export default function Home() {
  return (
    <main>
        ...
        <article className="experience-card featured-experience msci-experience">
          ...
          <details className="ownership-details msci-ownership" open>
            ...
            <ul>
              ...
              <li><strong>Extraction became production grade at petabyte scale.</strong> Built <span className="impact-text">petabyte-scale document data extraction</span> across annual reports, disclosures, PDFs and proprietary enterprise data sources using LLMs, RAG, specialized agents, tool calling, APIs and human-in-the-loop review. Outputs remained structured, traceable and ready for downstream data products.</li>
              <li><strong>The agent stack became deployable infrastructure.</strong> Developed <span className="impact-text">MCP servers, agent tools, reusable skills and integrations</span> alongside evaluation frameworks and deployment accelerators designed specifically for document extraction workflows.</li>
              <li><strong>Real-world AI behavior became debuggable.</strong> Systematically improved <span className="impact-text">prompts, retrieval, context, tools, orchestration, guardrails and model selection</span> by tracing extraction failures across the complete workflow and validating each change against ground truth.</li>
      ...
      <section className="section section-transition transition-from-paper here-zone" aria-label="HERE Technologies experience">
      ...
      <section className="section section-transition transition-from-here capability-section">
        <div className="section-heading">
      ...
      <section className="section section-transition transition-from-ink systems-section" id="systems">
      ...
      <section className="section section-transition transition-from-blue projects-section" id="projects">
        <div className="section-heading split-heading">
      ...
      <section className="contact-section section-transition transition-from-paper" id="contact">
